...
A simple Python port scanner I built while learning about **sockets and network connections**.
...
Only scan devices and networks that you own or have permission to test.
